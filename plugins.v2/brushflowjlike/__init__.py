...
class BrushFlowJlike(_PluginBase):
    # region 全局定义

    # 插件名称
    plugin_name = "站点刷流Jlike"
    # 插件描述
    ...
    # 作者主页
    author_url = "https://github.com/jlikeme"
    # 插件配置项ID前缀
    plugin_config_prefix = "brushflowjlike_"
    # 加载顺序
    plugin_order = 21
    # 可使用的用户级别
    auth_level = 2
    ...
    def __brush_site_torrents(self, siteid, torrent_tasks: Dict[str, dict], statistic_info: Dict[str, int],
        ...
        for torrent in torrents:
            ...
            self.eventmanager.send_event(etype=EventType.PluginTriggered, data={
                ...
                "event_name": "brushflowjlike_download_added",
                "hash": hash_string,
                "data": torrent_task,
